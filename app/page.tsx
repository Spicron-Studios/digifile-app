				...
				<div className="container mx-auto px-6">
					...
					>
						...
						<motion.p
							...
							variants={fadeIn}
						>
							Transform your medical practice with our innovative digital filing
							system. Secure, efficient, and designed for healthcare
							professionals.
						</motion.p>
					...
					>
						...
						>
							...
							<p className="text-gray-600">
								Secure digital storage for all your medical records
							</p>
						</motion.div>
				...
				<div className="container mx-auto px-6">
					...
					>
						...
						<p className="text-xl mb-8 opacity-90">
							Join thousands of healthcare professionals already using DigiFile
						</p>
						<motion.button
							whileHover={{ scale: 1.05 }}
							whileTap={{ scale: 0.95 }}
