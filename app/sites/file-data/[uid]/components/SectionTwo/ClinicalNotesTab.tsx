...
const mockEntries: TimelineEntry[] = [
  {
    date: "2024-06-25",
    time: "19:32",
    content: "Patient presented with persistent cough and fever. Prescribed antibiotics and recommended rest.",
    images: ["/placeholder.svg?height=150&width=150", "/placeholder.svg?height=150&width=150"]
  },
  {
    date: "2024-04-21",
    time: "19:45",
    content: "Follow-up examination shows improvement in lung function. Advised to continue with current treatment plan.",
